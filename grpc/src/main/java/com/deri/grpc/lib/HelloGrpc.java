...
public final class HelloGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.deri.grpc.lib.HelloOuterClass.HelloRequest,
      com.deri.grpc.lib.HelloOuterClass.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.deri.grpc.lib.HelloOuterClass.HelloRequest.class,
      responseType = com.deri.grpc.lib.HelloOuterClass.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.deri.grpc.lib.HelloOuterClass.HelloRequest,
      com.deri.grpc.lib.HelloOuterClass.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.deri.grpc.lib.HelloOuterClass.HelloRequest, com.deri.grpc.lib.HelloOuterClass.HelloReply> getSayHelloMethod;
      ...
      synchronized (HelloGrpc.class) {
        if ((getSayHelloMethod = HelloGrpc.getSayHelloMethod) == null) {
          HelloGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.deri.grpc.lib.HelloOuterClass.HelloRequest, com.deri.grpc.lib.HelloOuterClass.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Hello", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.deri.grpc.lib.HelloOuterClass.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.deri.grpc.lib.HelloOuterClass.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.deri.grpc.lib.HelloOuterClass.HelloRequest request,
        io.grpc.stub.StreamObserver<com.deri.grpc.lib.HelloOuterClass.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.deri.grpc.lib.HelloOuterClass.HelloRequest,
                com.deri.grpc.lib.HelloOuterClass.HelloReply>(
  ...
  public static final class HelloBlockingStub extends io.grpc.stub.AbstractStub<HelloBlockingStub> {
    ...
    /**
     */
    public com.deri.grpc.lib.HelloOuterClass.HelloReply sayHello(com.deri.grpc.lib.HelloOuterClass.HelloRequest request) {
  ...
  public static final class HelloFutureStub extends io.grpc.stub.AbstractStub<HelloFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.deri.grpc.lib.HelloOuterClass.HelloReply> sayHello(
        com.deri.grpc.lib.HelloOuterClass.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.deri.grpc.lib.HelloOuterClass.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.deri.grpc.lib.HelloOuterClass.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.deri.grpc.lib.HelloOuterClass.getDescriptor();
    }
